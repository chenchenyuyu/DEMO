...
import AdditiveBlendingShader from '../../../resources/shaders/VolumetricLightShader';
import VolumetricLightShader from '../../../resources/shaders/AdditiveBlendingShader';

// 1. AdditiveBlendingShader
// 2. VolumetricLightShader
extend({ EffectComposer, RenderPass, ShaderPass });

const DEFAULT_LAYER = 0;
const OCCLUSION_LAYER = 1;

const Torusknot = ({ layer = DEFAULT_LAYER }) => {
  const ref = useRef();
