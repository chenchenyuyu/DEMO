...
const VRLung = ({
  fileURL = 'http://192.168.111.97:8080/contour.vtp',
  materialGui
}) => {
...
const Lights = ({ light }) => {
  return (
    <group>
      ...
      <hemisphereLight {...light.hemiLight} />
      <directionalLight {...light.nested} position={[0, 0.1, -0.2]} />
      <directionalLight
        // color="#f0f0f0"
        // intensity={0.1}
        {...light.nested}
...
const LobeGeometryView = () => {
  ...
  return (
    ...
    >
      <Canvas camera={{ position: [0, 0, 400], near: 0.1, far: 1e7 }}>
      ...
      >
        ...
        <DatFolder title="THREE.HemisphereLight">
          <DatBoolean
            path="hemiLight.isHemisphereLight"
        ...
        <DatFolder title="THREE.DirectionalLight">
          <DatBoolean
            path="nested.isDirectionalLight"
